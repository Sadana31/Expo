    ...
    login=(userName,password)=>{
        ...
        .then(snapshot=>{
            snapshot.forEach(doc=>{
              this.setState({
                getPass: doc.data.password
              })
            })
        })

        if(password != this.state.getPass){
            ...
            <View style={styles.modalContainer}>
              <ScrollView style={{width:'100%'}}>
                ...
                <View style={styles.modalBackButton}>
                  ...
                  > 
                  <Text style={[styles.registerButtonText,{fontSize:18}]}>REGISTER </Text>
                  </TouchableOpacity>
                </View>
    ...
    render(){
        return (
            ...
            <View style={{borderWidth: 1, marginTop: 20, 
                borderRadius: 35, borderColor: "darkblue", padding: 20}}>
            ...
            <View style={{alignItems: "center", flex: 1}}> 
                ...
                <Text style={[styles.head, {marginTop: 20}]}>Don't have an account? Sign up</Text>
